...
const textNodes = [
  {
    ...
    options: [
      { text: 'Take the goo', setState: { blueGoo: true }, nextText: 2 },
      { text: 'Leave the goo', nextText: 2 }
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Find a room to sleep at in the town', nextText: 5 },
      { text: 'Find some hay in a stable to sleep in', nextText: 6 }
    ]
  },
  {
    id: 4,
  ...
  },
  {
    ...
    options: [{ text: 'Explore the castle', nextText: 7 }]
  },
  {
    id: 7,
    ...
    options: [
      ...
      { text: 'Attack it with your sword', requiredState: currentState => currentState.sword, nextText: 9 },
      { text: 'Hide behind your shield', requiredState: currentState => currentState.shield, nextText: 10 },
  ...
  },
  {
    ...
    options: [{ text: 'Congratulations. Play Again.', nextText: -1 }]
  }
];
